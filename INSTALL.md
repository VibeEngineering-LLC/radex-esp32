...
| **ESP-IDF** (`firmware-idf/`, релизы v1.x) | нужна оценка соответствия НРБ-99/2009, история показаний за месяцы на самой плате, устойчивое переподключение к прибору; плата — ESP32-S3-DevKitC-1 N16R8 | Путь 3 |
...
3. [Путь 3: ветка ESP-IDF](#путь-3-ветка-esp-idf)
...
1. **Скачайте образ** из [релиза v1.13.1](https://github.com/VibeEngineering-LLC/radex-esp32/releases/tag/v1.13.1):
