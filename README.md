...
*Плата, под которую собран образ: ESP32-S3-DevKitC-1 N16R8. Пример товара — [Ozon](https://ozon.ru/t/V2qn1g2), изображение с карточки. Обратите внимание на два разъёма USB-C: для прошивки нужен тот, что через мост USB-Serial (подробнее — в [INSTALL.md](INSTALL.md)).*
